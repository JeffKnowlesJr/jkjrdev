    ...
    <div className='w-full py-4 md:py-8 bg-midnight'>
      <div className='container-custom px-4 sm:px-6 lg:px-8'>
        <div className='mb-12 text-center'>
          <div className='h-12 w-48 bg-steel/20 rounded-lg mx-auto mb-6 animate-pulse' />
          <div className='h-4 w-96 bg-steel/20 rounded-lg mx-auto mb-8 animate-pulse' />
          <div className='h-10 w-64 bg-steel/20 rounded-lg mx-auto animate-pulse' />
        </div>
